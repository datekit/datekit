...
export default function NotFound() {
  return (
    <div className="relative isolate flex flex-auto flex-col items-center justify-center overflow-hidden bg-stone-950 text-center">
      <svg
        aria-hidden="true"
      ...
      <p className="mt-2 text-sm/6 text-stone-300">
