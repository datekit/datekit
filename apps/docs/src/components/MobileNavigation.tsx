...
function MobileNavigationDialog({
  ...
  return (
    ...
    >
      <DialogBackdrop
        transition
        className="fixed inset-0 top-14 bg-stone-400/20 backdrop-blur-sm data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in dark:bg-black/40"
      />
      ...
      <DialogPanel>
        ...
        <TransitionChild>
          <motion.div
            layoutScroll
            className="fixed bottom-0 left-0 top-14 w-full overflow-y-auto bg-white px-4 pb-4 pt-6 shadow-lg shadow-stone-900/10 ring-1 ring-stone-900/7.5 duration-500 ease-in-out data-[closed]:-translate-x-full min-[416px]:max-w-sm sm:px-6 sm:pb-10 dark:bg-stone-900 dark:ring-stone-800"
          >
            <Navigation />
          </motion.div>
        </TransitionChild>
