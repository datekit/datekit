  ...
  return (
    <>
      ...
      <Link
        ...
        tabIndex={-1}
        aria-hidden="true"
        className="text-base font-semibold text-stone-900 transition hover:text-stone-600 dark:text-white dark:hover:text-stone-300"
      >
        {page.title}
      </Link>
    </>
...
function SmallPrint() {
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-stone-900/5 pt-8 sm:flex-row dark:border-white/5">
      ...
      <div className="flex gap-4">
        ...
        {/*  Follow us on X*/}
        {/*</SocialLink>*/}
        <SocialLink href="#" icon={GitHubIcon} title="Star on GitHub">
          Follow us on GitHub
        </SocialLink>
